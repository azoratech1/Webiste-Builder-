      ...
      if (response.data.success && response.data.data.sections) {
        ...
        if (aboutSection?.content) {
          setAboutData(prev => ({
            ...prev,
            mission: {
              title: aboutSection.content.mission_title || prev.mission.title,
              description: aboutSection.content.mission || prev.mission.description,
              vision: aboutSection.content.vision || prev.mission.vision
            },
            values: aboutSection.content.values || prev.values
          }));
        }
      }
    } catch (error) {
